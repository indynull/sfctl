...
class TestSanitize:
    def test_strips_brackets_and_newlines(self):
        from sftui.widgets import _sanitize
...
class TestBuildLineStyles:
    def test_returns_styles_for_diff(self):
        from sftui.widgets import _build_line_styles
...
class TestFormatValue:
    def test_none(self):
        from sftui.widgets import _format_value
...
class TestTryParse:
    def test_json_dict(self):
        from sftui.widgets import _try_parse
...
class TestTraceEventDetailWidgets:
    def test_dict_args_and_dict_output(self):
        from sftui.widgets import trace_event_detail_widgets
...
class TestDiffDisplay:
    ...
    async def test_renders(self):
        ...
        from sftui.widgets import DiffDisplay
